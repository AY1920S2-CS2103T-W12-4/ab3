...
* *Major enhancement*: added *the ability to duplicate a recipe* (https://github.com/AY1920S2-CS2103T-W12-4/main/pull/293[#293])
...
* *Minor enhancement*: added a scale recipe command that allows the user to scale their recipes by a given size. (https://github.com/AY1920S2-CS2103T-W12-4/main/pull/294[#294])
...
*** Added command to mark a recipe as done (https://github.com/AY1920S2-CS2103T-W12-4/main/pull/114[#114])
** Community:
